...
public static class Localization
{
    ...
    private static readonly Dictionary<string, (string Nl, string En)> Strings = new()
    {
        ...
        ["weather.hourly_heading"] = ("Temperatuur per uur", "Temperature by hour"),
        ["weather.rain_heading"] = ("Neerslag per uur (mm)", "Precipitation by hour (mm)"),
        ["weather.rain_dry"] = ("Droog de komende {0}u", "Dry for the next {0}h"),
        ["weather.rain_window"] = ("Neerslag ~{0}-{1}u", "Precipitation ~{0}-{1}h"),
